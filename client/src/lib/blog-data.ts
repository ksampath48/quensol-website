...
export const blogPosts: BlogPost[] = [
  ...
  {
    slug: "hospital-infection-control-gloves",
    title: "The Role of Gloves in Hospital Infection Control Protocols",
    excerpt: "How proper glove selection, usage, and disposal directly impacts HAI rates — a guide for infection control officers and nursing managers.",
    category: "Technical Guide",
    readTime: "7 min read",
    date: "June 1, 2025",
    author: "Quensol Medical Team",
    ...
    content: [
      ...
      { heading: "When Gloves Are (and Aren't) Mandatory", body: "WHO Standard Precautions mandate gloves for: any anticipated contact with blood or body fluids, contact with mucous membranes or non-intact skin, handling contaminated equipment. Gloves are NOT required for routine patient care that does not involve exposure to body fluids. Over-gloving is itself a risk — it breeds complacency and reduces compliance with hand hygiene." },
      { heading: "Choosing the Right Glove for the Procedure", body: "Surgical procedures: sterile latex or nitrile surgical gloves (EN 455-1 to 4). Blood draws, IV insertion: non-sterile nitrile exam gloves (AQL 1.5). Handling chemotherapy drugs: chemotherapy-rated nitrile (ASTM D6978). Environmental cleaning: heavy-duty utility gloves (not exam gloves). Using exam gloves for high-risk chemical exposure is a common and dangerous error." },
      { heading: "Double-Gloving: When and Why", body: "Double-gloving reduces percutaneous exposure incidents by up to 87% in surgical settings. Recommended for: surgeries exceeding 90 minutes, orthopedic and trauma surgery, procedures in high HIV/HBV prevalence settings. The outer glove should be a half-size larger than the inner to prevent restriction. Use gloves from the same manufacturer for consistent sizing." },
      { heading: "Glove Failures and Root Causes", body: "The most common causes of glove failure: using the wrong glove for the chemical involved, exceeding the recommended wear time (most exam gloves are designed for single procedures under 60 minutes), incorrect donning that tears the fingertips, storing gloves in areas exposed to UV or ozone (near photocopiers, motors). Conduct a quarterly glove failure audit — ask staff to report tears and log them by product, size, and procedure." },
      { heading: "Building a Compliant Glove Programme", body: "1. Standardise your formulary to 3–4 approved SKUs. 2. Post sizing charts in every clinical area. 3. Train all staff annually on donning/doffing and double-gloving. 4. Audit glove usage quarterly against consumption data. 5. Report and investigate every glove failure. A well-run glove programme can reduce HAI rates by 15–20% while simultaneously reducing glove consumption by eliminating over-gloving." },
    ],
  },
  {
    slug: "nitrile-glove-shortage-alternatives",
    title: "Nitrile Glove Shortages: Causes, Alternatives, and How to Protect Your Supply",
    excerpt: "Post-pandemic supply chain disruptions are still impacting nitrile availability. Here's what procurement managers need to know and do right now.",
    category: "Procurement",
    readTime: "6 min read",
    date: "May 10, 2025",
    author: "Quensol Medical Team",
    ...
    content: [
      ...
      { heading: "Why Nitrile Supply Remains Vulnerable", body: "Over 65% of global nitrile glove production is concentrated in Malaysia, with Top Glove, Hartalega, and Kossan accounting for most output. Single-source concentration means regional events — floods, energy crises, labour disputes — can cascade into global shortages rapidly. Additionally, raw material costs (acrylonitrile, butadiene) are petrochemical-derived and fluctuate with oil prices." },
      { heading: "Viable Alternatives During Shortage Periods", body: "Vinyl (PVC) gloves: Cheaper, readily available, suitable for non-clinical tasks and food handling. Not recommended for blood/body fluid contact due to lower barrier protection. Neoprene gloves: Excellent chemical resistance, latex-free, but 2–3x the cost of nitrile. Chloroprene (CR) gloves: Very close to nitrile in performance, increasingly available from Indian manufacturers. Latex (if no allergy risk): Many facilities that moved away from latex can return to it temporarily for non-allergic staff during a nitrile shortage." },
      { heading: "How to Build Shortage-Resistant Procurement", body: "1. Maintain 60-day strategic reserves, not 30. 2. Qualify at least 2 approved suppliers per SKU. 3. Negotiate price caps in long-term contracts. 4. Monitor spot price indices monthly — MedPPE Index and WHO procurement data are good sources. 5. Establish a shortage response protocol with pre-approved substitution rules so nursing staff know what to use if the primary product is unavailable." },
      { heading: "Quensol's Supply Guarantee", body: "Quensol maintains 90-day forward inventory across all product lines and sources from both Malaysian and Indian manufacturing partners. Our standing order customers receive priority allocation in the event of a supply disruption. Contact us to discuss supply security planning for your facility." },
    ],
  },
  {
    slug: "standing-order-supply-management",
    title: "Why Standing Orders Are the Smarter Way to Manage Glove Supply",
    excerpt: "Spot buying gloves costs hospitals 18–25% more per year than managed standing orders. Here's the full financial and operational case.",
    category: "Procurement",
    readTime: "5 min read",
    date: "June 10, 2025",
    author: "Quensol Medical Team",
    ...
    content: [
      ...
      { heading: "The True Cost of Spot Buying", body: "Every spot purchase involves: 3–5 vendor quotes (30–60 min), a purchase order, a GRN, and an invoice reconciliation. For a 300-bed hospital making 8–10 glove purchases per month, that's 5–7 staff-hours monthly on procurement administration alone. Additionally, last-minute purchases (when stocks run out) are typically 15–25% more expensive than pre-negotiated rates." },
      { heading: "What a Standing Order Provides", body: "Fixed unit pricing for 6–12 months — eliminates market volatility. Automatic dispatch on a pre-set schedule — zero procurement administration. Priority stock allocation — never face stockouts. Consolidated invoicing — one invoice per month instead of per order. Volume incentives — the larger and longer your commitment, the better your pricing." },
      { heading: "Calculating Your Savings", body: "A typical 200-bed hospital spends ₹3–5 lakhs per month on gloves. Switching to a standing order typically delivers: 5–12% unit cost reduction, 15% reduction in wastage (predictable supply reduces panic stockpiling), and 8–10 staff-hours per month recovered. At ₹4 lakhs/month spend, that's ₹40,000–80,000 in direct cost savings annually, plus the staff time value." },
      { heading: "How to Set Up a Quensol Standing Order", body: "1. Request a consumption audit from our team — we'll analyse your historical orders. 2. We propose a monthly schedule and quantity. 3. You approve and sign a 6-month agreement (cancellable with 30 days notice). 4. Standing order begins — automatic dispatch, consolidated billing, dedicated account manager. Most customers are set up within 3 business days of their first enquiry." },
    ],
  },
];
