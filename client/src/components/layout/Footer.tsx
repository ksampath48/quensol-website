      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-16">
          ...
          <div className="space-y-4 lg:col-span-2">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a href="https://wa.me/917386101845" target="_blank" rel="noreferrer"
                className="w-9 h-9 bg-[#25D366] rounded-lg flex items-center justify-center hover:opacity-90 transition-opacity" aria-label="WhatsApp">
              ...
              <a href="mailto:support@quensol.com" className="w-9 h-9 bg-slate-700 rounded-lg flex items-center justify-center hover:bg-primary transition-colors" aria-label="Email">
                <Mail className="w-4 h-4" />
              </a>
              <a href="tel:+917386101845" className="w-9 h-9 bg-slate-700 rounded-lg flex items-center justify-center hover:bg-primary transition-colors" aria-label="Phone">
          ...
          {/* Shop */}
          <div>
            <h4 className="font-bold mb-5 text-sm uppercase tracking-widest text-slate-300">Shop</h4>
          ...
          {/* Resources */}
          <div>
            <h4 className="font-bold mb-5 text-sm uppercase tracking-widest text-slate-300">Resources</h4>
            <ul className="space-y-3 text-sm text-slate-400">
        ...
        <div className="border-t border-slate-800 pt-8 pb-6">
          <div className="flex flex-wrap gap-3 justify-center md:justify-start">
            {["ISO 9001:2015", "CE Marked", "FDA Listed", "ASTM D6319", "EN 374"].map((cert) => (
              <span key={cert} className="text-xs text-slate-500 border border-slate-700 px-3 py-1 rounded-md">{cert}</span>
            ))}
          </div>
        </div>
        ...
        <div className="border-t border-slate-800 pt-6 flex flex-col md:flex-row justify-between items-center gap-3 text-xs text-slate-500">
          ...
          <div className="flex gap-5 flex-wrap justify-center">
            ...
            <a href="/shipping" className="hover:text-slate-300 transition-colors">Shipping</a>
